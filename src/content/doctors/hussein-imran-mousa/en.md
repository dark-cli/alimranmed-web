...
description: >-
  Consultant Neurosurgeon at Alsadr Teaching Hospital, Basra. Over 25 years in neurosurgery with 5000+ independent
  operations.
...
heroLede: >-
  Founder and lead consultant of Alimran Clinic. Consultant Neurosurgeon, Neurosurgical Department, Basra Teaching
  Hospital, and Iraq Director for Middle East Stereotactic and Functional Neurosurgery.
sections:
  - type: stats
    items:
      - value: 5,000+
      ...
      - value: "25"
        label: Years of neurosurgical practice behind the clinic
      - value: "4"
        label: Departments — surgery, pain medicine, physiotherapy, rehabilitation
      - value: "6"
        label: Clinic days a week, including an out-of-hours on-call roster
  - type: list
    variant: rows
