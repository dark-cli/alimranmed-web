...
description: "Anterior cervical discectomy and fusion (ACDF) is a type of neck surgery that involves removing a damaged disc to relieve"
category: "surgery"
order: 999
legacyUrl: "https://alimranmed.com/anterior-cervical-discectomy-and-fusion-3/"
source: "ai-draft"
---
...
Before surgery, intravenous antibiotics are given to reduce the risk of infection. The surgery is performed through a small incision on either the right or left side of the neck over the herniated disc. Surgical dissection continues down to the cervical spine while gently retracting the large artery in the neck (the carotid artery) to one side, while the swallowing tube (esophagus) and breathing tube (trachea) are pushed to the other side. The level of the patient's herniated disc is confirmed with X-rays. The microscope is then used for the remainder of the operation. After the herniated disc is removed, the neurosurgeon can see and remove any bone spurs pressing on the nerve or spinal cord. The area is then inspected to ensure there are no disc fragments or other structures that may be compressing the nerve or spinal cord. The wound is irrigated with an antibiotic solution to reduce the likelihood of infection. A fixed or mobile artificial disc made of titanium, or natural or artificial bone, is then placed at the site of the removed disc. Often, a titanium plate is placed in front of the spine using screws in the cervical vertebrae above and below the discectomy to maintain spinal alignment. You may need to wear a cervical collar after surgery. If necessary, it will be placed on your neck at the end of the operation.
