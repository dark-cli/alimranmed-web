  ...
  - type: at_a_glance
    items:
      ...
      - label: "What it treats"
        value: "Disc herniation, spinal canal stenosis (foraminal, lateral recess, central), facet and sacroiliac joint syndrome, and diskogenic pain syndrome."
      - label: "What to expect"
        value: "Surgery is performed through a small access port using a full endoscope. Three approaches — transforaminal, extraforaminal, and interlaminar — are selected based on the specific pathology and spinal level."
  - type: prose
    heading: "Endoscopic spine surgery at Alimran Medical Center"
    body: |
      Full-endoscopic spine surgery uses a high-resolution endoscope to provide intraoperative imaging through minimised access ports. This approach implements minimally invasive surgical concepts while maintaining the precision required for spinal pathology.

      Three standardised surgical approaches are used depending on the location and type of pathology:

      **Transforaminal technique** — used for pathologies at L4/5 and higher segments. Lateral transforaminal access targets intraspinal and intraforaminal pathologies; posterolateral access targets intradiscal pathologies.

      **Extraforaminal technique** — used for extraforaminal disc herniations and foraminal stenosis at all lumbar and thoracic segments.
