  ...
  - type: at_a_glance
    items:
      ...
      - label: "What it treats"
        value: "Vertebral compression fractures causing severe pain and disability, most commonly from osteoporosis."
      - label: "What to expect"
        value: "Outpatient procedure. Pain relief is typically rapid once cement hardens. Kyphoplasty is a variation that uses balloons to create space before cementing, correcting deformity and restoring vertebral height."
  - type: prose
    heading: "Vertebroplasty at Alimran Medical Center"
    body: |
      Vertebroplasty is an outpatient procedure for stabilising compression fractures of the spine. Bone cement is injected into cracked or broken vertebrae — most commonly caused by osteoporosis — where it hardens quickly, stabilising the fracture and supporting the spinal column.

      For patients suffering from severe, disabling pain caused by vertebral compression fractures, vertebroplasty can provide rapid and meaningful pain relief, increased mobility, and a significant reduction in pain medication use.
