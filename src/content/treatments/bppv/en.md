...
sections:
  - type: at_a_glance
    items:
      ...
      - label: "Symptoms"
        value: "Vertigo, dizziness, imbalance, nausea, and vomiting. Episodes last under one minute, may disappear for a period, then recur. Abnormal eye movements (nystagmus) are common."
      - label: "Approach"
        value: "Canalith repositioning (e.g. Epley manoeuvre) is the primary treatment and works within one or two sessions. Physiotherapy and rTMS support recovery when symptoms persist."
  - type: media
    kind: image
  ...
  - type: prose
    ...
    body: |
      Benign paroxysmal positional vertigo is one of the most common causes of vertigo — the sudden sensation that you or your surroundings are spinning. Episodes are brief, typically lasting under a minute, and are almost always triggered by a change in head position: tilting the head up or down, lying down, turning over in bed, or sitting up.

      Although BPPV can be distressing, it is rarely dangerous unless it increases the risk of falls.

      **Causes:** In many cases no cause is found (idiopathic BPPV). When a cause is identified, it is typically a minor to severe blow to the head. Less commonly, inner-ear disorders, ear surgery, or prolonged positioning on the back (such as in a dentist's chair) are responsible. BPPV is also associated with migraines.
