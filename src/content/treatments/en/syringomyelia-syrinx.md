...
description: "Also known as syringomyelia and hydromyelia are commonly known as syrinx. Essentially, a syrinx is a fluid collection in the"
locale: "en"
category: "spine"
order: 999
...
There are many different opinions as to how best treat these collections. In the broadest sense they are as follows. One, if there is an obvious cause (such as hydrocephalus or Chiari Malformation) treat the cause with the expectation that the syrinx will then resolve on its own. Two, treat the syrinx as the initial problem with some form of drain. Three, combine both of these options and treat both the cause and the syrinx at the same operation.
