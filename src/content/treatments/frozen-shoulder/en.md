  ...
  - type: at_a_glance
    items:
      ...
      - label: "How we treat it"
        value: "Physiotherapy for range; intra-articular injection to break the pain cycle; capsular release surgery in the small stuck-solid minority."

  - type: prose
    heading: "What frozen shoulder is"
    body: |
      Frozen shoulder — clinically, adhesive capsulitis — is an inflammatory condition in which the capsule around the shoulder joint thickens, tightens, and adheres to itself. The result is severe pain and progressive loss of movement, particularly external rotation.
