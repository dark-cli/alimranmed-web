...
sections:
  - type: at_a_glance
    items:
      ...
      - label: "Emergency signs"
        value: "Loss of consciousness, vomiting, seizure, worsening headache, weakness on one side, unequal pupils, clear fluid from nose or ear."
      - label: "How we treat it"
        value: "Immediate CT to stratify risk; observation, surgical evacuation of significant clots, and structured rehabilitation for the deficits that remain."

  - type: prose
    heading: "What head injury covers"
    body: |
      Head injury is a broad term. At one end sits a mild concussion — no imaging changes, symptoms clear within days. At the other sits a major intracranial bleed that needs an emergency operation within the hour. The whole spectrum is triaged by the same clinical framework: level of consciousness (Glasgow Coma Scale), pupil examination, focal neurology, and — for anything but the mildest injury — a CT scan.
  ...
  - type: stats_facts
    ...
    facts:
      ...
      - "Loss of consciousness, amnesia, seizure, repeated vomiting, or focal neurology all lower the threshold for imaging."
      - "Post-concussion syndrome — headache, dizziness, poor concentration — can persist for weeks after a mild injury; it does not mean the initial scan was wrong."
