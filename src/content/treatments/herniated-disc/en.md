...
sections:
  - type: at_a_glance
    items:
      ...
      - label: "Typical signs"
        value: "Sharp pain radiating into an arm or leg (depending on level), with numbness, tingling, or weakness in the same distribution."
      - label: "How we treat it"
        value: "Conservative care for most — physiotherapy, medication, targeted injection; surgery only when weakness progresses or pain does not settle."

  - type: prose
    heading: "What a herniated disc is"
    body: |
      Intervertebral discs sit between spinal vertebrae, acting as shock absorbers and permitting movement. Each disc has a tough fibrous outer ring (annulus fibrosus) and a soft gel-like core (nucleus pulposus). When the outer ring tears, the core can push outward, forming a herniation.
