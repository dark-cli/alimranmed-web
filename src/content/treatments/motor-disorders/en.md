...
sections:
  - type: at_a_glance
    items:
      ...
      - label: "Typical signs"
        value: "Stiffness, involuntary writhing or tremor, difficulty initiating movement, imbalance, or uncontrolled limb movements."
      - label: "How we treat it"
        value: "Physical therapy and stretching are foundation. Botulinum toxin for focal spasticity. Functional neurosurgery (selective dorsal rhizotomy, stereotactic lesioning) for severe, disabling cases."
  ...
  - type: related
    slugs: ["parkinsons-disease", "spinal-cord-injury"]
---
