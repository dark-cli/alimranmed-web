...
locale: "ar"
title: "العمود الفقري"
description: "حالات تصيب الحبل الشوكي والعمود الفقري وجذور الأعصاب — تتراوح من الشذوذات الخلقية والإصابات الرضية إلى أمراض القرص التنكسية وأورام الحبل الشوكي. تصفّح الحالات التي نعالجها أدناه."
  ...
  - type: at_a_glance
    items:
      ...
      - label: "المظاهر الشائعة"
        value: "ألم رقبي أو ظهري يمتد إلى الأطراف؛ ضعف أو خدر في الذراعين أو الساقين؛ اضطراب التوازن والمشية؛ خلل المثانة أو الأمعاء؛ تشنج عضلي؛ أو عجز عصبي تدريجي."
      - label: "المقاربة"
        value: "تقييم بالرنين المغناطيسي للقطعة الشوكية المعنية والفحص العصبي. تتراوح الإدارة من العلاج الطبيعي وتدخلات الألم للحالات التنكسية إلى رأب الضغط الجراحي والتثبيت للأمراض الهيكلية الضاغطة. يُستخدَم التعديل العصبي للألم المزمن والتشنج."
  - type: prose
